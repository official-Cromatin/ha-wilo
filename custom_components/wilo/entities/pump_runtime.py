"""Custom entity implementation for pump runtime."""
...
class PumpRuntimeSensor(WiloBaseEntity, SensorEntity):
    """Sensor for pump runtime."""
    ...
    def __init__(self, coordinator, pump, category_key, value_key):
        ...
        self._attr_translation_key = "pump_runtime"
